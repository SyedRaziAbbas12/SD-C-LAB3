...
public class MAIN{
    public static void main(String[] args) {
        // Creating Customer
        Customer customer = new Customer("C001", "naqvi", "123 Maple St", 1234567890, 28);
        customer.addDetails();

        // Creating Agent
        Agent agent = new Agent(101, "razi abbas");

        // Creating BookingCounter
        BookingCounter bookingCounter = new BookingCounter();

        // Creating Ticket
        Ticket ticket = new Ticket("rawalpindi", "lahore", "2024-11-20", "10:00 AM", "Bus304", "A1");
